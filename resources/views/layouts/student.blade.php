        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('student.course') }}">Courses</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('student.notifications') }}">Notifications</a></li>
